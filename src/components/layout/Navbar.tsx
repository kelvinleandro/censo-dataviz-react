      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="shrink-0 flex items-center gap-2 cursor-pointer">
            <div className="w-8 h-8 rounded bg-deco-emerald flex items-center justify-center text-background font-bold">
              BR
            </div>
        ...
        <div className="md:hidden bg-background border-b border-muted">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {chapters.map((item) => (
              ...
              >
                <span>
                  <span className="text-deco-emerald text-xs uppercase mr-2">Cap {item.id}</span>
                  {item.description}
                </span>
